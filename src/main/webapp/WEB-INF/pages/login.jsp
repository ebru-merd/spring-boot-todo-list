               ...
               <form id="loginform" action="/security_login" method="post">
                ...
                <div class="container-login100-form-btn">
                    <div class="wrap-login100-form-btn">
                        ...
                        <button class="login100-form-btn"type="button" id="registerBtn" formtarget="_blank" onclick="controlLogin()">
                            Giriş
                        </button>
                    </div>
                </div>
                <div class="container text-center" id="error" style="display: none"><p>Kullanıcı adı ve şifrenizi kontrol ediniz!</p></div>
